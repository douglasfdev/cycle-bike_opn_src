...
{
    public record CreateProduct(string Name, decimal Price, string Description, string CreatedBy) : Message, ICommand;
    public record CreateCachedProduct(string Name, decimal Price, string Description, string CreatedBy) : CreateProduct(Name, Price, Description, CreatedBy);
